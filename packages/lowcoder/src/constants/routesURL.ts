...
export const AUTH_CAPTCHA_URL = `${USER_AUTH_URL}/captchaPage`;
export const VERIFY_RANDOMCODE_URL = `${USER_AUTH_URL}/verifyEmail`;
export const AUTH_RESETPASSWORD_URL = `${USER_AUTH_URL}/resetPassword`;
