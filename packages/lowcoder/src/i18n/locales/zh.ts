...
export const zh = {
  ...
  notSupportedBrowser:
    "您当前使用的浏览器可能存在兼容性问题.为了获得更好的用户体验,建议使用最新版本的Chrome浏览器",
  create: "创建",
  move: "移动",
  addItem: "添加",
  newItem: "新建",
  ...
  gridCompOperator: {
    ...
    cutCompsSuccess:
      "剪切成功!您可以使用 {pasteKey} 进行粘贴,或使用 {undoKey} 撤销操作.",
  },
  leftPanel: {
    queries: "查询",
    globals: "全局变量",
  ...
  prop: {
    ...
    customRule: "自定义规则",
    customRuleTooltip:
      "如果结果是非空字符串,则为错误消息.如果为空或null,则验证通过.\n示例:",
    manual: "手动",
    map: "映射",
    json: "JSON",
    use12Hours: "使用12小时制",
    ...
    maskClosable: "点击蒙层关闭",
    showMask: "显示蒙层",
    videokey: "翻译: Video Key",
    data: "翻译: Data",
    textOverflow: "翻译: Text Overflow",
  },
  autoHeightProp: {
    auto: "自动",
    fixed: "固定",
  ...
  eventHandler: {
    ...
    notifyDurationTooltip:
      "时间单位可以是秒(默认为s)或毫秒(ms),最大持续时间为{max}秒",
    goToURL: "跳转到URL链接",
    ...
    throttle: "节流",
    slowdownTooltip:
      "使用防抖或节流控制操作触发的频率,时间单位可以是毫秒(默认为ms)或秒(s).",
    notHandledError: "未处理",
    currentApp: "当前应用程序",
  },
  event: {
  ...
  query: {
    ...
    failConditionTooltip2:
      "如果任何条件返回true,则将查询标记为失败并触发相应的通知.",
    showSuccessNotification: "执行成功时显示通知",
    successMessageLabel: "成功消息",
    successMessage: "执行成功",
    notifyDuration: "持续时间",
    notifyDurationTooltip:
      "通知持续时间.时间单位可以是秒(s,默认)或毫秒(ms).默认值为{default}s,最大值为{max}s.",
  ...
  sqlQuery: {
    ...
    allowMultiModifyTooltip:
      "如果选择此参数,将操作符合条件的所有行.否则,只会操作符合条件的第一行.",
    array: "数组",
    insertList: "插入列表",
  ...
  customComp: {
    ...
    data: "翻译: Data you want to pass to the Custom Component",
    code: "翻译: Code of your Custom Component",
  },
  tree: {
    placeholder: "请选择",
    selectType: "选择类型",
    ...
    checkStrictly: "严格勾选",
    checkStrictlyTooltip: "精确勾选树节点；父树节点和子树节点不关联",
    treeData: "树数据",
    treeDataDesc: "当前树数据",
    value: "默认值",
    valueDesc: "当前值",
    ...
    helpChildren: "子节点",
    helpDisabled: "禁用节点",
    helpSelectable: "节点是否可选择（单选/多选类型）",
  ...
  richTextEditor: {
    ...
    edit: "编辑",
    remove: "移除",
    toolbar: "翻译: Customize Toolbar",
    toolbarDescription:
      "翻译: You can customize the toolbar. Please refer to: https://quilljs.com/docs/modules/toolbar/ for more details.",
    defaultValue: "翻译: Base Content",
  },
  numberInput: {
    formatter: "格式",
    precision: "精度",
  ...
  file: {
    typeErrorMsg:
      "必须是一个带有有效文件大小单位的数字,或者是一个无单位的字节数.",
    fileEmptyErrorMsg: "上传失败.文件大小为空.",
    fileSizeExceedErrorMsg: "上传失败.文件大小超过限制.",
    minSize: "最小大小",
    minSizeTooltip:
      '上传文件的最小大小,可选择使用文件大小单位(例如:"5kb"、"10MB").如果没有提供单位,该值将被视为字节数.',
    maxSize: "最大大小",
    maxSizeTooltip:
      '上传文件的最大大小,可选择使用文件大小单位(例如:"5kb"、"10MB").如果没有提供单位,该值将被视为字节数.',
    single: "单个",
    multiple: "多个",
    directory: "目录",
    upload: "浏览",
  ...
  date: {
    ...
    startDate: "开始日期",
    endDate: "结束日期",
    placeholderText: "翻译: Placeholder",
  },
  time: {
    start: "开始时间",
    end: "结束时间",
  ...
  textShow: {
    text: "### 👋 你好,{name}",
    valueTooltip:
      "Markdown支持大多数HTML标签和属性.出于安全原因,禁用了iframe、script和其他标签.",
  ...
  table: {
    ...
    viewModeResizableTooltip: "用户是否可以调整列宽。",
    showFilter: "显示过滤按钮",
    showRefresh: "显示刷新按钮",
    showDownload: "显示下载按钮",
    ...
    hideOnSinglePage: "在单页时隐藏",
    showSizeChanger: "显示大小更改按钮",
    pageSizeOptions: "每页显示选项",
    pageSize: "每页显示数量",
    total: "总行数",
    totalTooltip:
    ...
    option1: "操作1",
    status: "状态",
    statusTooltip: "可选值: 成功、错误、默认、警告、处理中",
    primaryButton: "主要",
    defaultButton: "默认",
    type: "类型",
    tableSize: "表格大小",
    hideHeader: "隐藏表头",
    fixedHeader: "固定表头",
    fixedHeaderTooltip: "垂直可滚动表格的表头将被固定",
    fixedToolbar: "固定工具栏",
    fixedToolbarTooltip: "基于位置，垂直可滚动表格的工具栏将被固定",
    hideBordered: "隐藏列边框",
    deleteColumn: "删除列",
    ...
    middle: "中",
    large: "大",
    refreshButtonTooltip: "当前数据变化，点击重新生成列。",
    changeSetDesc:
      "代表可编辑表格更改的对象，只包含更改的单元格。行排在前，列排在后。",
    selectedRowDesc:
      "提供当前选定行的数据，指示如果用户点击行上的按钮/链接，则触发点击事件的行",
    selectedRowsDesc: "在多选模式下有用，与selectedRow相同",
    pageNoDesc: "当前显示页，从1开始",
    pageSizeDesc: "每页显示多少行",
    sortColumnDesc: "当前选择的排序列的名称",
    sortDesc: "当前行是否按降序排列",
    pageOffsetDesc:
      "当前分页的起始点，用于分页获取数据。示例: 从Users表中选择 * Limit '{{table1.pageSize}}' Offset '{{table1.pageOffset}}'",
    displayDataDesc: "当前表格中显示的数据",
    selectedIndexDesc: "在显示数据中选定的索引",
    filterDesc: "表格过滤参数",
    dataDesc: "表格的 JSON 数据",
    saveChanges: "保存更改",
    cancelChanges: "取消更改",
    rowSelectChange: "行选择更改",
    rowClick: "行点击",
    rowExpand: "行展开",
    filterChange: "过滤更改",
    sortChange: "排序更改",
    ...
    rowColor: "条件行颜色",
    rowColorDesc:
      '根据可选变量条件设置行颜色: CurrentRow、CurrentOriginalIndex、CurrentIndex、ColumnTitle。例如: \'{{ currentRow.id > 3 ? "green" : "red" }}\'',
    rowHeight: "条件行高",
    rowHeightDesc:
      '根据可选变量条件设置行高: CurrentRow、CurrentOriginalIndex、CurrentIndex、ColumnTitle。例如: \'{{ currentRow.id > 3 ? "60px" : "40px" }}\'',
    cellColor: "条件单元格颜色",
    cellColorDesc:
      '根据单元格值使用CurrentCell条件设置单元格颜色。例如: \'{{ currentCell == 3 ? "green" : "red" }}\'',
    saveChangesNotBind:
      "未配置保存更改的事件处理程序。请在单击之前绑定至少一个事件处理程序。",
    dynamicColumn: "使用动态列设置",
    dynamicColumnConfig: "列设置",
    dynamicColumnConfigDesc:
      '动态列设置。接受列名称的数组。默认情况下，所有列都是可见的。例如: ["id", "name"]',
    position: "位置",
    showDataLoadSpinner: "在数据加载期间显示旋转器",
    showValue: "显示值",
    expandable: "可展开",
    configExpandedView: "配置扩展视图",
    toUpdateRowsDesc: "要在可编辑表格中更新的行的对象数组。",
    empty: "空",
    falseValues: "假值文本",
    allColumn: "全部",
    visibleColumn: "可见",
    emptyColumns: "当前没有列可见",
  },
  image: {
    src: "图片链接",
    srcDesc: "图片链接地址",
  ...
  QRCode: {
    ...
    level: "容错级别",
    levelTooltip:
      "指的是二维码被遮挡的部分仍然能够被扫描出来的程度.级别越高,二维码越复杂、被遮挡的部分越多,仍然能够被扫描出来的可能性就越大",
    includeMargin: "显示边距",
    image: "图片",
    valueDesc: "二维码的内容",
    L: "L (低)",
  ...
  switchComp: {
    ...
    closeDesc: "切换关闭时触发",
    valueDesc: "当前开关状态",
    defaultValue: "翻译: Default Boolean Value",
  },
  signature: {
    tips: "提示",
    signHere: "在此处签名",
  ...
  transformer: {
    ...
    documentationText:
      "翻译: Transformers are designed for data transformation and reuse of your multi-line JavaScript code. Use Transformers to adapt Data from queries or components to your local App needs. Unlike JavaScript query, transformer is designed to do read-only operations, which means that you cannot trigger a query or update a temporary state inside a transformer.",
  },
  temporaryState: {
    value: "初始值",
    ...
    documentationText:
      "翻译: Temporary states in Lowcoder are a powerful feature used to manage complex variables that dynamically update the state of components in your application. These states act as intermediary or transient storage for data that can change over time due to user interactions or other processes.",
  },
  dataResponder: {
    data: "数据",
    dataDesc: "当前数据响应器的数据",
  ...
  advanced: {
    ...
    preloadJSHelp:
      "为当前工作空间中的所有应用程序设置预加载的 JavaScript 代码.",
    ...
    saveSuccess: "保存成功",
    AuthOrgTitle: "翻译: Workspace Welcome Screen",
    AuthOrgDescrition:
      "翻译: The URL for Your Users to Sign In to the Current Workspace.",
  },
  branding: {
    title: "品牌",
    logoTitle: "Logo",
  ...
  module: {
    ...
    emptyEvent: "尚未添加事件",
    event: "事件",
    docLink: "翻译: Read More About Modules...",
    documentationText:
      "翻译: Lowcoder Modules are complete Applications, that can get included and repeated in other Lowcoder Applications and it functions just like a single component. As modules can get embedded, they need to be able to interact with your outside apps or websites. This four settings help to support communication with a Module.",
  },
  resultPanel: {
  ...
  apiMessage: {
    ...
    functionNotSupported:
      "当前版本不支持此功能.请联系 Lowcoder 业务团队升级您的账户",
  },
  globalErrorMessage: {
  ...
  header: {
    ...
    recoverAppSnapshotContent: "将当前应用恢复到{time}创建的版本。",
    ...
    appSettings: "应用设置",
    preview: "预览",
    editError: "历史预览模式，不支持任何操作。",
    clone: "克隆",
    editorMode_layout: "布局",
    editorMode_logic: "逻辑",
    editorMode_both: "两者",
  },
  userAuth: {
    ...
    imageCaptcha:"图片验证码:",
    captchaImage:"验证码图片",
    incorrectCaptchaEntered:"输入图片验证码",
    sendEmail:"获取验证码",
  ...
  preLoad: {
    jsLibraryHelpText:
      "通过URL链接向当前应用程序添加JavaScript库.lodash、day.js、uuid、numbro内置于系统中,可立即使用.JavaScript库在应用程序初始化之前加载,这可能会影响应用程序的性能.",
    exportedAs: "导出为",
    urlTooltip:
      "JavaScript库的URL链接,建议使用[unpkg.com](https://unpkg.com/)或[jsdelivr.net](https://www.jsdelivr.com/).",
    recommended: "推荐",
    ...
    jsLibraryInstallFailedCloud:
      "可能该库在沙盒中不可用,[文档](https://docs.lowcoder.cloud/build-apps/write-javascript/use-third-party-libraries#manually-import-libraries)\n{message}",
    jsLibraryInstallFailedHost: "{message}",
    add: "新增",
    jsHelpText: "向当前应用程序添加全局方法或变量.",
    cssHelpText:
      "向当前应用程序添加样式.由于系统进行迭代,DOM结构可能会发生变化.请尝试通过组件属性修改样式.",
    scriptsAndStyles: "脚本和样式",
  ...
  editorTutorials: {
    component: "组件",
    componentContent:
      "右侧的组件区域拥有表格、按钮、输入框、选择器等组件,可以拖动到画布上进行使用.",
    canvas: "画布",
    canvasContent:
      "画布上所见即所得,您可以通过拖放来调整组件的布局和大小,使用键盘快捷键删除/复制/粘贴组件.",
    queryData: "查询数据",
    queryDataContent:
      "在此处创建新的查询,并连接到您的MySQL、PostgreSQL、MongoDB、Redis、Airtable等数据源.配置查询后,点击“运行”获取数据.",
    compProperties: "组件属性",
  },
  homeTutorials: {
    createAppContent:
      "🎉 欢迎使用{productName},点击“应用程序”开始创建您的第一个应用程序.",
  ...
  docUrls: {
    ...
    introVideo: "",
    devNpmPlugin:
      "https://docs.lowcoder.cloud/build-plugins/develop-your-first-plugin",
    devNpmPluginText: "如何开发npm插件?",
    useHost:
      "https://docs.lowcoder.cloud/self-hosting/access-local-database-or-api",
    eventHandlerSlowdown:
      "https://docs.lowcoder.cloud/build-apps/event-handlers#debounce-and-throttle",
    thirdLib:
      "https://docs.lowcoder.cloud/build-apps/write-javascript/use-third-party-libraries",
  ...
  queryTutorial: {
    js: "",
    transformer:
      "https://docs.lowcoder.cloud/build-apps/write-javascript/transformers",
    tempState:
      "https://docs.lowcoder.cloud/build-apps/write-javascript/temporary-state",
    dataResponder:
  ...
  componentDoc: {
    markdownDemoText:
      "**Lowcoder** 是一个开发人员友好的开源低代码平台,可在几分钟内构建内部应用.",
    demoText:
      "Lowcoder 是一个开发人员友好的开源低代码平台,可在几分钟内构建内部应用.",
    submit: "提交",
    style: "样式",
    ...
    propertyUsage:
      "您可以通过在任何可以编写 JavaScript 的地方访问组件属性来读取与组件相关的信息.",
    property: "属性",
    propertyName: "属性名称",
    propertyType: "类型",
    propertyDesc: "描述",
    ...
    mehtod: "方法",
    methodUsage:
      "您可以通过方法与组件进行交互,并且可以在任何可以编写 JavaScript 的地方通过它们的名称调用它们.或者您可以通过事件的“控制组件”操作来调用它们.",
    methodName: "方法名称",
    methodDesc: "描述",
    showBorder: "显示边框",
    haveTry: "自行尝试",
  ...
  playground: {
    ...
    methodParams: "方法参数",
    methodParamsHelp:
      "输入方法参数使用 JSON,例如,可以使用 [1] 或 1 来设置 setValue 的参数.",
  },
  calendar: {
  ...
  componentDocExtra: {
    table: "翻译: Additional Documentation for Table Component",
  },
  idSource: {
    title: "OAuth 提供商",
    form: "电子邮件",
    ...
    lockModalContent:
      "更改“ID属性”字段可能对用户识别产生重大影响,请在继续之前确认您理解此更改的影响.",
    payUserTag: "高级",
  },
  slotControl: {
  ...
  timeLine: {
    ...
    pendingDescription:
      "翻译: When Set, Then a Last Node With the Text and a Waiting Indicator Will Be Displayed.",
  },
  jsonLottie: {
    lottieJson: "JSON数据",
    speed: "播放速度",
  ...
  meeting: {
    ...
    meetingCompKeywords: "声网会议、Web 会议、协作",
    iconSize: "图标大小",
    userId: "主持人用户 ID",
    roomId: "房间 ID",
