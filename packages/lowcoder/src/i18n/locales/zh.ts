...
export const zh = {
  ...
  query: {
    ...
    failConditionTooltip2:
      "如果任何条件返回true,则将动作标记为失败并触发相应的通知.",
    ...
    confirmationMessage: "您确定要运行此动作吗?",
    newQuery: "新建动作",
    newFolder: "新建应用",
    recentlyUsed: "最近使用",
    folder: "应用",
    folderNotEmpty: "应用不为空",
    dataResponder: "数据响应器",
    tempState: "临时状态",
    transformer: "转换器",
    quickRestAPI: "REST查询",
    ...
    database: "数据库",
    cloudHosting:
      "云托管的云梯无法访问您的本地服务,如使用127.0.0.1或localhost.请尝试连接公共网络数据源或使用反向代理来访问您的私有服务.",
    notCloudHosting:
      "对于Docker托管部署,云梯使用桥接网络,因此对于主机地址,127.0.0.1和localhost是无效的.要访问本地机器上的数据源,请参考以下链接",
    ...
    save: "保存",
    whitelist: "白名单",
    whitelistTooltip: "当需要时,将以下云梯的IP地址添加到数据源的白名单中.",
    address: "地址:",
  ...
  audio: {
    src: "音频链接",
    defaultSrcUrl: "https://cdn-files.cloudladder.net.cn/canon-excerpt.mp3",
    autoPlay: "自动播放",
    loop: "循环播放",
    srcDesc: "当前音频链接",
    play: "播放",
  ...
  theme: {
    ...
    subTitle: "标题",
    linkLabel: "链接",
    linkUrl: "cloud.cloudladder.net.cn",
    progressLabel: "进度",
    sliderLabel: "滑块",
    radioLabel: "单选按钮",
    checkboxLabel: "复选框",
  ...
  preLoad: {
    jsLibraryHelpText:
      "通过URL链接向当前应用程序添加JavaScript库.lodash、moment、uuid、numbro内置于系统中,可立即使用.JavaScript库在应用程序初始化之前加载,这可能会影响应用程序的性能.",
    exportedAs: "导出为",
    urlTooltip:
    ...
    jsLibraryInstallFailedCloud:
      "可能该库在沙盒中不可用,[文档](https://docs.cloudladder.net.cn/build-apps/write-javascript/use-third-party-libraries#manually-import-libraries)\n{message}",
  ...
  home: {
    ...
    trashEmpty: "回收站为空.",
    projectEmpty: "这里没有内容.",
    projectEmptyCanAdd: "您还没有任何页面、模块或者导航.点击“新建”开始.",
    name: "名称",
    type: "类型",
    creator: "创建者",
    lastModified: "上次修改",
  ...
  docUrls: {
    docHome: "https://docs.cloudladder.net.cn/",
    components: "https://cloud.cloudladder.net.cn/components?n={compType}",
    module: "",
    optionList: "",
    terms: "",
    privacy: "",
    ...
    introVideo: "",
    devNpmPlugin:
      "https://docs.cloudladder.net.cn/build-plugins/develop-your-first-plugin",
    devNpmPluginText: "如何开发npm插件?",
    useHost:
      "https://docs.cloudladder.net.cn/self-hosting/access-local-database-or-api",
    eventHandlerSlowdown:
      "https://docs.cloudladder.net.cn/build-apps/event-handlers#debounce-and-throttle",
    thirdLib:
      "https://docs.cloudladder.net.cn/build-apps/write-javascript/use-third-party-libraries",
  ...
  queryTutorial: {
    js: "",
    transformer:
      "https://docs.cloudladder.net.cn/build-apps/write-javascript/transformers",
    tempState:
      "https://docs.cloudladder.net.cn/build-apps/write-javascript/temporary-state",
  },
  customComponent: {
    entryUrl: "https://sdk.cloudladder.net.cn/custom_component.html",
  },
  template: {
  ...
  componentDoc: {
    markdownDemoText:
      "**云梯** 是一个开发人员友好的开源低代码平台,可在几分钟内构建内部应用.",
    demoText:
      "云梯 是一个开发人员友好的开源低代码平台,可在几分钟内构建内部应用.",
    submit: "提交",
    style: "样式",
